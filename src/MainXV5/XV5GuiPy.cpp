...
static PyObject *
XV5Gui_showMainWindow(PyObject * /*self*/, PyObject *args)
{
...
static PyObject *
XV5Gui_exec_loop(PyObject * /*self*/, PyObject *args)
{
...
static PyObject *
XV5Gui_setupWithoutGUI(PyObject * /*self*/, PyObject *args)
{
    if (!PyArg_ParseTuple(args, ""))
        return NULL;
    ...
    if (!Gui::Application::Instance) {
        ...
        PyErr_SetString(PyExc_RuntimeError, "XV5Gui already initialized");
        return 0;
    }
...
static PyObject *
XV5Gui_embedToWindow(PyObject * /*self*/, PyObject *args)
{
    char* pointer;
    ...
    if (!widget) {
        PyErr_SetString(Base::BaseExceptionXV5Error, "No main window");
        return 0;
    }
    ...
    if (!Gui::MainWindow::getInstance()) {
        ...
        if (!init) {
            try {
                ...
                Base::Interpreter().runString(Base::ScriptFactory().ProduceScript("XV5GuiInit"));
            }
            catch (const Base::Exception& e) {
                PyErr_Format(Base::BaseExceptionXV5Error, "Error in XV5GuiInit.py: %s\n", e.what());
                return 0;
            }
            init = true;
        }
...
PyMODINIT_FUNC initXV5Gui()
{
    try {
        Base::Interpreter().loadModule("XV5");
        App::Application::Config()["AppIcon"] = "XV5";
        App::Application::Config()["SplashScreen"] = "XV5splash";
        App::Application::Config()["CopyrightInfo"] = "\xc2\xa9 Juergen Riegel, Werner Mayer, Yorik van Havre 2001-2015\n";
        Gui::Application::initApplication();
        Py_InitModule("XV5Gui", XV5Gui_methods);
    }
    catch (const Base::Exception& e) {
